    ...
    tiers: [
      {
        ...
        abilityDesc: 'Zaps one enemy for 100% ATK, then bounces to another for 50% ATK.',
      ...
      },
      {
        ...
        spd: 16,
        abilityName: 'Chain Lightning+',
        abilityDesc: 'Zaps one for 100% ATK, then bounces to TWO others at 50% each.',
        abilityType: 'hit_one_bounce',
        abilityPower: 1.0,
      ...
      },
      {
        ...
        abilityDesc: 'Hits ALL enemies for 80% ATK. 15% chance to stun each for 1 turn.',
        abilityType: 'hit_all_enemies',
        abilityPower: 0.8,
        abilityExtra: { stunChance: 0.15, stunDuration: 1 },
      },
    ],
  },
